      ...
      _from_user_id: {
        follow: {
          ...
          delete: (option: {
            ...
            >(prefix, PATH1, DELETE, option, 'URLSearchParams').json(),
          /**
           * Unfollow
           * @returns success response
           */
          $delete: (option: {
            ...
            fetch<
              ...
              BasicHeaders,
              Methods1['delete']['status']
            >(prefix, PATH1, DELETE, option, 'URLSearchParams')
              .json()
              .then((r) => r.body),
          $path: () => `${prefix}${PATH1}`,
        },
      ...
      _hackathon_id: {
        ...
        get: (option: {
          ...
          fetch<
            ...
            BasicHeaders,
            Methods5['get']['status']
          >(prefix, PATH5, GET, option, 'URLSearchParams').json(),
        /**
         * Get my bookmarks
         * @returns delete success response
         */
        $get: (option: {
          ...
          fetch<
            ...
            BasicHeaders,
            Methods5['get']['status']
          >(prefix, PATH5, GET, option, 'URLSearchParams')
            .json()
            .then((r) => r.body),
        /**
      ...
      _room_id: {
        ...
        members: {
          ...
          delete: (option?: { config?: T | undefined } | undefined) =>
            ...
            >(prefix, PATH13, DELETE, option).json(),
          /**
           * Remove Account In Rooms
           * @returns success response
           */
